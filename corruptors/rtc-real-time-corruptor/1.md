...
[**Check RTC\_VectorEngine.cs on Github for exact values of the lists**](https://github.com/ircluzar/RTC3/blob/master/Real-Time Corruptor/BizHawk_RTC/BizHawk.Client.EmuHawk/RTC/RTC_VectorEngine.cs)
