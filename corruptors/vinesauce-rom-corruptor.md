...
>#####[You can view the wiki pages for the Real Time Corruptor here](https://corrupt.wiki/corruptors/rtc-real-time-corruptor.html)
---
...
* [**Index**](#index "Literally this")
  ...
  * [**Byte Corruption**](#byte-corruption)
    ...
    * [Text Replacement](#text-replacement---ascii)
...
##### Shift right by _x_ bytes - Decimal
...
##### Replace _x \_with_ y \_- HEX

When using this option, each corrupted byte will be compared to the first value \(_x\), \_if it matches it will be replaced with _\(y\), \_the second value. So only matching bytes will be corrupted, other bytes remain untouched.
