...
* [Index](#index)
  * [N64 Corruption with the Vinesauce ROM Corruptor](#n64-corruption-with-the-vinesauce-rom-corruptor)
    ...
    * [Setting The Values](#setting-the-values)
      * [Start Byte/End Byte](#startend-byte)
      * [Corrupt Every](#corrupt-every)
      * [Add/Shift](#addshift)
      * [Replace](#replace)
      * [Special Cases](#special-cases)
    * [Save States](#save-states)
  * [Decompressed ROM Corruptions with VSRC](#decompressed-rom-corruptions-with-vrc)
    * [Basis](#basis)
  ...
  * [N64 Corruption with the Real-Time Corruptor](#n64-corruption-with-the-vinesauce-rom-corruptor)
    * TODO
...
There are two decompressors out there for N64: [SM64 ROM extender](https://www.smwcentral.net/?p=section&a=details&id=4812) and [ZDEC](http://www.mediafire.com/file/3v3v94llaqaccaj/ZDEC.rar), which is for Ocarina of Time and Majora’s Mask. If you intend to follow with the N64 corruption examples given, you need the right version of Super Mario 64, which can be found denoted as Super Mario 64 \(U\) \[!\]. If you're not sure you have the right ROM, try a corruption and see if it works as intended. Example corruptions for each of these games and a text file with a rough mapping of the SM64 ranges can be found below.  
...
](https://www.dropbox.com/sh/jl147aectlhvvoo/UCSfeVXf-_)

For examples of these corruptions in action, look up Vinesauce’s videos of corruptions of these games. Credit goes to Nephkin for finding the range for the SM64 corruptions of Mario’s face and SmellyFeetYouHave for the idea of the decompressed ROM corruptions.  


### N64 Corruption with the Real-Time Corruptor
